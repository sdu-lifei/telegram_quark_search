...
class CanApplyBoostRequest(TLRequest):
    CONSTRUCTOR_ID = 0xdb05c1bd
    SUBCLASS_OF_ID = 0x5716fc3c

    def __init__(self, peer: 'TypeInputPeer'):
        """
        :returns stories.CanApplyBoostResult: Instance of either CanApplyBoostOk, CanApplyBoostReplace.
        """
        self.peer = peer
...
class GetBoostersListRequest(TLRequest):
    CONSTRUCTOR_ID = 0x337ef980
    SUBCLASS_OF_ID = 0x2f351376

    def __init__(self, peer: 'TypeInputPeer', offset: str, limit: int):
        """
        :returns stories.BoostersList: Instance of BoostersList.
        """
        self.peer = peer
        self.offset = offset
        self.limit = limit
...
class GetBoostsStatusRequest(TLRequest):
    CONSTRUCTOR_ID = 0x4c449472
    SUBCLASS_OF_ID = 0xdb73c5e4

    def __init__(self, peer: 'TypeInputPeer'):
        """
        :returns stories.BoostsStatus: Instance of BoostsStatus.
        """
        self.peer = peer
